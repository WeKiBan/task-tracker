...
export const mockTasks = [
  ...
  },
  {
    ...
    status: 'blocked',
    link: '#',
    description: 'Blocked due to a dependency on the Instagram API integration.',
  ...
  },
  {
    ...
    status: 'inProgress',
    link: '#',
    description: 'Implementing the latest design changes for the motor review page.',
  ...
  },
  {
    ...
    status: 'closed',
    link: 'www.google.com',
    description: 'Finalized the implementation of the site search functionality.',
